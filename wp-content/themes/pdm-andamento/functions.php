...
function indicadores_register() {
    ...
    $args = array(
		...
		'capability_type' => 'post',
        'capabilities' => array(
            'publish_posts' => 'publish_grande_indicador',
            'edit_posts' => 'edit_grande_indicador',
            'edit_others_posts' => 'edit_others_grande_indicador',
            'read_private_posts' => 'read_private_grande_indicador',
            'edit_post' => 'edit_grande_indicador',
            'delete_post' => 'delete_grande_indicador',
            'read_post' => 'read_grande_indicador',
        ),
		'hierarchical' => false,
		'menu_position' => null,
		'taxonomies' =>false
